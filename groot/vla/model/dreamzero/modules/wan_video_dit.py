...
DISABLE_TORCH_COMPILE_ENV = os.getenv("DISABLE_TORCH_COMPILE", "False").lower() in ("1", "true", "yes")
TORCHDYNAMO_DISABLED_ENV = os.getenv("TORCHDYNAMO_DISABLE", "0").lower() in ("1", "true", "yes")
if ENABLE_TENSORRT:
    ...
    DISABLE_TORCH_COMPILE = DISABLE_TORCH_COMPILE_ENV or TORCHDYNAMO_DISABLED_ENV
